...
class RecipeBeefListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Beef").order_by('-recipe_timestamp') 
...
class RecipePorkListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Pork").order_by('-recipe_timestamp') 
...
class RecipeLambListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Lamb").order_by('-recipe_timestamp') 
...
class RecipeChickenListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Chicken").order_by('-recipe_timestamp') 
...
class RecipeFishListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Fish").order_by('-recipe_timestamp') 
...
class RecipeVegetableListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Vegetable").order_by('-recipe_timestamp') 
...
class RecipeSoupListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Soup").order_by('-recipe_timestamp') 
...
class RecipeDessertListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Dessert").order_by('-recipe_timestamp') 
...
class RecipeCakeListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Cake").order_by('-recipe_timestamp') 
...
class RecipeOtherListView(ListView):
    ...
    queryset = Recipe.objects.filter(recipe_food_group__icontains="Other").order_by('-recipe_timestamp') 
